...
export default function LandingPage() {
    return (
        <div className="flex flex-col pt-[6.3rem] max-h-[110vh]">
            ...
            <div className="flex flex-col pt-16 px-[22rem] gap-10 -mb-[4rem]">
                <span className="border border-[#020617] w-[70%]"></span>
                <span className="dm-sans font-normal text-xl w-[65%]">At Var Studio, we bring your ideas to life with cutting-edge, tailored digital solutions—designed one var at a time.</span>
            </div>
